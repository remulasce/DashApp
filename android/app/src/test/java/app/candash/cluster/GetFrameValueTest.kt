...
class GetFrameValueTest {
    ...
    @Test
    fun testSpeed() {
        val speedCANSignal = CANSignal(SName.vehicleSpeed, 0, Hex(0x257), 12, 12, .08f, -40f)
        val payloadBinaryString = "0110111001000110000111110000000000000000101000000000111100000001"
    ...
    @Test
    fun testFrunkState() {
        val frunkCanSignal = CANSignal(SName.frunkState, 0, Hex(0x2E1), 3, 4, 1f, 0f, 3, 0)
    ...
    @Test
    fun testBatteryAmps() {
        val batteryCanSignal = CANSignal(SName.battAmps, 0, Hex(0x132), 16, 16, -.1f, 0f, signed=true)
